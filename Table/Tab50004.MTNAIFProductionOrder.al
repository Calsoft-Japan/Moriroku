table 50004 MTNA_IF_ProductionOrder
{
    //CS 2024/9/5 Channing.Zhou FDD304 Table for MTNA IF Production Order
    ...
    trigger OnInsert()
    var
        RecMNTAIFProductionOrder: Record "MTNA_IF_ProductionOrder";
        LastEntryNo_: integer;
    begin
        LastEntryNo_ := 0;
        if RecMNTAIFProductionOrder.FindLast() then begin
            LastEntryNo_ := RecMNTAIFProductionOrder."Entry No.";
        end;
        LastEntryNo_ += 1;
