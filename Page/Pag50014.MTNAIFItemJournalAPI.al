page 50014 MTNA_IF_ItemJournal_API
{
    //CS 2024/9/5 Channing.Zhou FDD307 Page for MTNA IF Item Journal API
    ApplicationArea = All;
    ...
    APIGroup = 'MTNAIF';
    APIVersion = 'v2.0';
    EntitySetCaption = 'MTNA IF Item Journals';
    EntitySetName = 'itemJournal';
    EntityCaption = 'MTNA IF Item Journal';
    EntityName = 'mtnaIFItemJournal';
